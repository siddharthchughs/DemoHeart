...
public class DateUtils {
    ...
    public static String getMonthAndYearDate(Context context, Calendar calendar) {
        return String.format("%s %s",context.getResources().getStringArray(R.array.material_calendar_months_array)[calendar.get(Calendar.MONTH)],
                calendar.get(Calendar.YEAR));
    }
    public static String getDayOfWeek(Context context,Calendar calDate, Calendar calendar) {
        return String.format("%s %s %s",context.getResources().getStringArray(R.array.material_calendar_months_array)[calendar.get(Calendar.DAY_OF_MONTH)],
