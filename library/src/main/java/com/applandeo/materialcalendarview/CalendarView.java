...
public class CalendarView extends LinearLayout {
    ...
    private final ViewPager.OnPageChangeListener onPageChangeListener = new ViewPager.OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            Calendar calendarDay = (Calendar) mCalendarProperties.getFirstPageCalendarDate().clone();
            calendarDay.add(Calendar.DAY_OF_MONTH, position);
...
//            if (!isScrollingLimited(calendar,position)) {
//                setHeaderDayName(calendar,position);
//            }
        }
    ...
    private void setHeaderDayName(Calendar calendar, Calendar calDay,int position) {
        mCurrentMonthLabel.setText(DateUtils.getDayOfWeek(mContext,calDay,calendar));
        callOnPageChangeListeners(position);
    }
