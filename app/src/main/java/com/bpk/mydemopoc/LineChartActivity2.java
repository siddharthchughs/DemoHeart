...
public class LineChartActivity2 extends DemoBase implements OnSeekBarChangeListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {   // // Y-Axis Style // //
            ...
            yAxis.enableGridDashedLine(10f, 9f, 0f);
...

        {
            ...
            // add limit lines for the Max heart rate range
            ...
            // add limit lines for the Min heart rate range

            LimitLine llXAxis = new LimitLine(9f, "Min Rate");
            llXAxis.setLineWidth(4f);
            llXAxis.enableDashedLine(10f, 20f, 0f);
