...
//                mRenderPaint.setStyle(Paint.Style.FILL_AND_STROKE);
  ...
  //              c.drawLines(mShadowBuffers, mRenderPaint);
                ...
                if (open > close) { // decreasing
                    ...
                    if (dataSet.getIncreasingColor() == ColorTemplate.COLOR_BAR) {
                        mRenderPaint.setColor(dataSet.getColor(j));
                    } else {
                ...
                mOpenBuffers[0] = xPos - 0.2f + barSpace;
                mOpenBuffers[1] = open * phaseY;
                mOpenBuffers[2] = xPos;
                mOpenBuffers[3] = open * phaseY;

                mCloseBuffers[0] = xPos + 0.2f - barSpace;
                ...
                if (open > close)
                    barColor = dataSet.getDecreasingColor() == ColorTemplate.COLOR_BAR
                            ? dataSet.getColor(j)
                            : dataSet.getDecreasingColor();
//                else if (open < close)
//                    barColor = dataSet.getIncreasingColor() == ColorTemplate.COLOR_BAR
//                            ? dataSet.getColor(j)
//                            : dataSet.getIncreasingColor();
                else
                    barColor = dataSet.getNeutralColor() == ColorTemplate.COLOR_BAR
                            ? dataSet.getColor(j)
                            : dataSet.getNeutralColor();
